    ...
    case WM_PAINT:
        {
			...
			void far settextstyle(int font, int direction, char size3);
			...
			TextOut(hdc, 600, 0, str, wcslen(str));

			

			if (health <= 0)
			{
				swprintf(str, 64, L"游戏结束，打字速度：%.2f 个每秒",
